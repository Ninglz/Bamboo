package com.ninglz.bamboo.auth.support;
 ...
 */
public class BambooRedisTokenStore implements TokenStore {
	...
	public BambooRedisTokenStore(RedisConnectionFactory connectionFactory, KeyStrResolver resolver) {
