...
import com.ninglz.bamboo.commoon.knife.support.*;
...
public class GatewaySwaggerAutoConfiguration {
	...
	@Bean
	@Primary
	public SwaggerProvider swaggerProvider(RouteDefinitionRepository repository, KnifeProperties swaggerProperties,
	...
	@Bean
	public RouterFunction swaggerRouterFunction(KnifeProperties swaggerProperties, SwaggerUiHandler swaggerUiHandler,
